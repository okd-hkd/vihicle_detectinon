...
while cap.isOpened():  # True if initialized
...
print(f'car_image.shape: {car_image.shape}')
...
print(f'gray_car_image: {gray_car_image}')
...
print(f'binary_car_image: {binary_car_image}')
...
if(flag==0):
    ...
    for region in regionprops(label_image):
        ...
        if region_height >= min_height and region_height <= max_height and region_width >= min_width and region_width <= max_width and region_width > region_height:
            ...
            ax1.add_patch(rectBorder)
            # let's draw a red rectangle over those regions
    print(f'plate_like_objects[0]: {plate_like_objects[0]}')
    # print(f'plate_like_objects[1]: {plate_like_objects[1]}')
    plt.show()